...
![](05_Java_迭代器与List、Set集合.assets/迭代器原理图.bmp)
...
![](05_Java_迭代器与List、Set集合.assets/堆栈.png)
...
![](05_Java_迭代器与List、Set集合.assets/队列.png)
...
- 查找元素快：通过索引，可以快速访问指定位置的元素
  ...
  ![](05_Java_迭代器与List、Set集合.assets/数组查询快.png)

- 增删元素慢

- **指定索引位置增加元素**：需要创建一个新数组，将指定新元素存储在指定索引位置，再把原数组元素根据索引，复制到新数组对应索引的位置。如下图

  ![](05_Java_迭代器与List、Set集合.assets/数组添加.png)

- **指定索引位置删除元素：**需要创建一个新数组，把原数组元素根据索引，复制到新数组对应索引的位置，原数组中指定索引位置元素不复制到新数组中。如下图![](05_Java_迭代器与List、Set集合.assets/数组删除.png)
...
- **链表**:**linked list**,由一系列结点node（链表中每一个元素称为结点）组成，结点可以在运行时i动态生成。每个结点包括两个部分：一个是存储数据元素的数据域，另一个是存储下一个结点地址的指针域。我们常说的链表结构有单向链表与双向链表，那么这里给大家介绍的是**单向链表**。
  ...
  ![](05_Java_迭代器与List、Set集合.assets/单链表结构特点.png)
...
![](05_Java_迭代器与List、Set集合.assets/1.png) 
...
![](05_Java_迭代器与List、Set集合.assets/2.png)
...
![](05_Java_迭代器与List、Set集合.assets/3.png)
...
![](05_Java_迭代器与List、Set集合.assets/4.png)
...
![](05_Java_迭代器与List、Set集合.assets/5.png)
...
![](05_Java_迭代器与List、Set集合.assets/左旋.png)
...
![](05_Java_迭代器与List、Set集合.assets/右旋.png)
...
![](05_Java_迭代器与List、Set集合.assets/6.png)
...
![](05_Java_迭代器与List、Set集合.assets/7.png) 
...
![](05_Java_迭代器与List、Set集合.assets/8.png) 
...
![](05_Java_迭代器与List、Set集合.assets/11.png)
...
![](05_Java_迭代器与List、Set集合.assets/12.png)



前面也说了，右左跟左右其实互为镜像，所以调整过程就反过来，先对节点"15"进行右旋，使得二叉树变成右右，之后再对"11"节点进行左旋，此时二叉树就调整完成，如下图:

![](05_Java_迭代器与List、Set集合.assets/13.png)
...
![](05_Java_迭代器与List、Set集合.assets/14.png) 



右右只需对节点进行一次左旋即可调整平衡，如下图，对"11"节点进行左旋。

![](05_Java_迭代器与List、Set集合.assets/15.png) 
...
![](05_Java_迭代器与List、Set集合.assets/16.png)
...
另外，List集合还有一个特点就是**元素有序**，即元素的存入顺序和取出顺序一致。
...
![](05_Java_迭代器与List、Set集合.assets/双向链表.png)
...
`java.util.HashSet`是`Set`接口的一个实现类，它所存储的元素是不可重复的，并且**元素都是无序的**(即存取顺序不能保证不一致)。`java.util.HashSet`底层的实现其实是一个`java.util.HashMap`支持，由于我们暂时还未学习，先做了解。
...
简单的来说，哈希表是由数组+链表+红黑树（JDK1.8增加了红黑树部分）实现的，如下图所示。![](05_Java_迭代器与List、Set集合.assets/哈希表.png) 

看到这张图就有人要问了，这个是怎么存储的呢？

为了方便大家的理解我们结合一个存储流程图来说明一下：

![](05_Java_迭代器与List、Set集合.assets/哈希流程图.png)
