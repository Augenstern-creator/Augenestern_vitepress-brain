...
![image-20210726195845175](CSS(二).assets/5.png)
...
![image-20210726202009102](CSS(二).assets/6.png)

比较难，虽然转换为行内块元素可以实现一行显示，但是他们之间会有大的空白缝隙，很难控制。

2. 提问：如何实现两个盒子的左右对齐？

![image-20210726202055357](CSS(二).assets/7.png)
...
![image-20210726202822809](CSS(二).assets/8.png)



2. 如果多个盒子都设置了浮动，则它们会按照属性值**一行内显示并且顶端对齐排列**

![image-20210726203707405](CSS(二).assets/9.png)
...
![image-20210726204148968](CSS(二).assets/10.png)
...
![image-20210726204608414](CSS(二).assets/11.png)
